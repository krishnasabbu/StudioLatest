...
export default function LivePreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="w-[95vw] h-[90vh] rounded-lg shadow-2xl flex flex-col bg-white">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="w-80 border-r overflow-y-auto border-gray-200 bg-gray-50">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {hyperlinks.map((link) => (
                      <div
                        key={link.id}
                        className="p-2 rounded text-xs bg-white">
          ...
          <div className="flex-1 overflow-auto p-6">
            <div className="min-h-full rounded-lg border bg-white border-gray-200">
              <div
                className="p-6"
